...
namespace Titanic.Tests
{
    ...
    public class TitanicTest
    {
        ...
        public void Setup()
        {
            ...
            using (var reader = File.OpenText(@"E:\projects\Kaggle\titanic\docs\data\train.csv"))
            ...
            using (var reader = File.OpenText(@"E:\projects\Kaggle\titanic\docs\data\test.csv"))
            using (var csv = new CsvReader(reader))
            {
                while (csv.Read())
                {
        ...
        public void prediction()
        {
            ...
            testData.WriteSubmission(@"E:\projects\Kaggle\titanic\docs\out\gender_submission.csv");
        }
